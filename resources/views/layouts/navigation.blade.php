        ...
        <div class="flex items-start justify-between mb-10">
            ...
            <div id="notification-area" class="hidden lg:block relative">
                <button onclick="openNotificationModal()" class="relative p-2 text-zinc-800 dark:text-zinc-400 hover:text-orange-500 transition-colors">
                    ...
                    <span id="notif-count" class="hidden absolute top-1 right-1 flex items-center justify-center h-5 w-5 text-[10px] font-bold text-white bg-red-600 rounded-full ring-2 ring-zinc-300 dark:ring-zinc-900">
                        0
                    </span>
                </button>
            </div>
