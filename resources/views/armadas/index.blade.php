<x-app-layout>
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-white">Manajemen Armada</h1>
                ...
                <table class="w-full min-w-[700px] divide-y divide-zinc-800">
                    ...
                    <thead class="bg-zinc-950">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-medium text-zinc-400">Kapasitas</th>
                            <th class="px-6 py-4 text-left text-xs font-medium text-zinc-400">No. Plat</th>
